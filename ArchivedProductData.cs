...
{
    internal class ArchivedProductData
    {
        ...
        public List<ArchivedProductData> AllProductData()
        {
            List<ArchivedProductData> listData = new List<ArchivedProductData>();
                ...
                "Server=LAPTOP-E6DHJ1I3\\SQLEXPRESS;Database=inventory;Trusted_Connection=true;TrustServerCertificate=true;"))
            {
                ...
                string selectData = "SELECT * FROM archivedproducts";
